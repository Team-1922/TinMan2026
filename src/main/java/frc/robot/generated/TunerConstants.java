...
public class TunerConstants {
    ...
    public static final CANBus kDrivebaseCANBus = new CANBus("Drivebase", "./logs/example.hoot");
    public static final CANBus kTopsideCANBus = new CANBus("Topside");
    ...
    public static final SwerveDrivetrainConstants DrivetrainConstants = new SwerveDrivetrainConstants()
            .withCANBusName(kDrivebaseCANBus.getName())
