...
public class TunerConstants {
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = switch (Constants.robotType) {
  ...
  private static final double kDriveGearRatio = switch (Constants.robotType) {
  ...
  private static final Angle kFrontLeftEncoderOffset = switch (Constants.robotType) {
  ...
  private static final Distance kFrontLeftXPos = switch (Constants.robotType) {
  ...
  private static final Angle kFrontRightEncoderOffset = switch (Constants.robotType) {
  ...
  private static final Distance kFrontRightXPos = switch (Constants.robotType) {
    case TinmanV0 -> Inches.of(9.5);
    case TinmanV1 -> Inches.of(12.375);
  };
  ...
  private static final Angle kBackLeftEncoderOffset = switch (Constants.robotType) {
  ...
  private static final Distance kBackLeftXPos = switch (Constants.robotType) {
    case TinmanV0 -> Inches.of(-9.5);
    case TinmanV1 -> Inches.of(-12.375);
  };
  ...
  private static final Angle kBackRightEncoderOffset = switch (Constants.robotType) {
  ...
  private static final Distance kBackRightXPos = switch (Constants.robotType) {
    case TinmanV0 -> Inches.of(-9.5);
    case TinmanV1 -> Inches.of(-12.375);
  };
